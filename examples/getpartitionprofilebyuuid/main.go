...
func main() {
	...
	_, lparUUID, err := restClient.GetLogicalPartitionByName(systemUUID, *lparName, *verbose)
	if err != nil {
	...
	profile, err := restClient.GetLogicalPartitionProfile(lparUUID, profileUUID, *verbose)
	if err != nil {
